    ...
    return [
        types.Tool(
            ...
            description=(
                ...
                "  The report includes a <checklist_data> JSON block at the end.\n"
                "  ALWAYS call the write_checklist_excel tool with that JSON block.\n"
                "  DO NOT build the Excel yourself with openpyxl or bash — use the tool.\n"
                "  The tool fills the official 8-sheet Incorta template on the server and\n"
                "  returns a { download_url } — present it to the user as a clickable link.\n\n"
                "Args:\n"
